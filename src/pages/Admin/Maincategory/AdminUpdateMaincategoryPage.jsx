      ...
      <div className="container-fluid my-3">
        <div className="row">
          ...
          <div className="col-md-9 mb-3">
            <h5 className='bg-primary text-light text-center p-2'>Update Maincategory <Link to="/admin/maincategory"><i className='fa fa-arrow-left-long text-light float-end'></i></Link></h5>
