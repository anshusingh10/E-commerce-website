      ...
      <div className="container-fluid my-3">
        <div className="row">
          ...
          <div className="col-md-9 mb-3">
            <h5 className='bg-primary text-light text-center p-2'>Create Feature <Link to="/admin/feature"><i className='fa fa-arrow-left-long text-light float-end'></i></Link></h5>
            <form onSubmit={postData}>
              <div className="row">
                ...
                <div className="col-12 mb-3   ">
                  ...
                  <textarea name="description" onChange={getInputData} rows={2} placeholder='Description...' className={`form-control border-3 ${show && errorMessage.message ? 'border-danger' : 'border-primary'}`} textarea />
                  {show && errorMessage.message ? <p className='text-danger text-capitalize'>{errorMessage.message}</p> : null}
                </div>
                <div className="col-md-6 mb-3">
                  <label>Icon*</label>
                  <input type="text" name="icon" onChange={getInputData} placeholder='Icon...' className={`form-control border-3 ${show && errorMessage.icon ? 'border-danger' : 'border-primary'}`} />
