      ...
      <div className="container-fluid my-3">
        <div className="row">
          ...
          <div className="col-md-9 mb-3">
            <h5 className='bg-primary text-light text-center p-2'>Update Product <Link to="/admin/product"><i className='fa fa-arrow-left-long text-light float-end'></i></Link></h5>
            <form onSubmit={postData}>
              <div className="row">

                <div className="col-12 mb-3">
                  <label>Name*</label>
                  <input type="text" name="name" value={data.name} onChange={getInputData} placeholder='Product Name' className={`form-control border-3 ${show && errrorMessage.name ? 'border-danger' : 'border-primary'}`} />
                  {show && errrorMessage.name ? <p className='text-danger text-capitalize'>{errrorMessage.name}</p> : null}
                </div>

                <div className="col-md-3 mb-3">
                  <label>Maincategory*</label>
                  <select name="maincategory" onChange={getInputData} value={data.maincategory} className='form-control border-3 border-primary'>
                    {
                ...
                <div className="col-md-3 mb-3">
                  ...
                  <select name="subcategory" onChange={getInputData} value={data.subcategory} className='form-control border-3 border-primary'>
                    {
                ...
                <div className="col-md-3 mb-3">
                  <label>Brand*</label>
                  <select name="brand" onChange={getInputData} value={data.brand} className='form-control border-3 border-primary'>
                    {
                ...
                <div className="col-md-3 mb-3">
                  <label>Stock*</label>
                  <select name="stock" onChange={getInputData} value={data.stock ? "1" : "0"} className='form-control border-3 border-primary'>
                ...
                <div className="col-md-6 mb-3">
                  <label>Color*</label>
                  <input type="text" name="color" onChange={getInputData} value={data.color} placeholder='Product Color' className={`form-control border-3 ${show && errrorMessage.color ? 'border-danger' : 'border-primary'}`} />
                  {show && errrorMessage.color ? <p className='text-danger text-capitalize'>{errrorMessage.color}</p> : null}
                </div>

                <div className="col-md-6 mb-3">
                  <label>Size*</label>
                  <input type="text" name="size" onChange={getInputData} value={data.size} placeholder='Size' className={`form-control border-3 ${show && errrorMessage.size ? 'border-danger' : 'border-primary'}`} />
                  {show && errrorMessage.size ? <p className='text-danger text-capitalize'>{errrorMessage.size}</p> : null}
                </div>

                <div className="col-md-6 mb-3">
                  <label>Base Price*</label>
                  <input type="number" name="basePrice" onChange={getInputData} value={data.basePrice} placeholder='Base Price' className={`form-control border-3 ${show && errrorMessage.basePrice ? 'border-danger' : 'border-primary'}`} />
                  {show && errrorMessage.basePrice ? <p className='text-danger text-capitalize'>{errrorMessage.basePrice}</p> : null}
                </div>

                <div className="col-md-6 mb-3">
                  <label>Discount*</label>
                  <input type="number" name="discount" onChange={getInputData} value={data.discount} placeholder='Discount' className={`form-control border-3 ${show && errrorMessage.discount ? 'border-danger' : 'border-primary'}`} />
                ...
                <div className="col-md-6 mb-3">
                  ...
                  <input type="number" name="stockQuantity" onChange={getInputData} value={data.stockQuantity} placeholder='Stock Quantity' className={`form-control border-3 ${show && errrorMessage.stockQuantity ? 'border-danger' : 'border-primary'}`} />
                ...
                <div className="col-md-6 mb-3">
                  <label className='d-block'>Old Pics(Click to Remove)</label>
                  {
