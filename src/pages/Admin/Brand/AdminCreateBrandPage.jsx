    ...
    if (error) {
      ...
      if (item) {
        setErrorMessage((old) => {
          return {
            ...old,
            "name": "This Brand with same name  is already exist"
          }
        })
        setShow(true)
        return
      ...
      <div className="container-fluid my-3">
        <div className="row">
          ...
          <div className="col-md-9 mb-3">
            <h5 className='bg-primary text-light text-center p-2'>Create Brand <Link to="/admin/brand"><i className='fa fa-arrow-left-long text-light float-end'></i></Link></h5>
